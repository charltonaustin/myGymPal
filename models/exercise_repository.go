...
func (r *ormExerciseRepository) Create(userID int64, name string, isBodyweight bool, goalWeight float64, weightUnit string, isTimeBased bool, goalSeconds int) (*Exercise, error) {
	return CreateExercise(userID, name, isBodyweight, goalWeight, weightUnit, isTimeBased, goalSeconds)
}
...
func (r *ormExerciseRepository) Update(id, userID int64, name string, isBodyweight bool, goalWeight float64, weightUnit string, isTimeBased bool, goalSeconds int) (*Exercise, error) {
	return UpdateExercise(id, userID, name, isBodyweight, goalWeight, weightUnit, isTimeBased, goalSeconds)
}
