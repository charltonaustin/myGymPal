...
func (r *ormExerciseRepository) Create(userID int64, name string, isBodyweight bool, goalWeight float64, weightUnit string) (*Exercise, error) {
	return CreateExercise(userID, name, isBodyweight, goalWeight, weightUnit)
}
...
func (r *ormExerciseRepository) Update(id, userID int64, name string, isBodyweight bool, goalWeight float64, weightUnit string) (*Exercise, error) {
	return UpdateExercise(id, userID, name, isBodyweight, goalWeight, weightUnit)
}
