...
| exercise         | Per-user exercise library entry with normalized lowercase name, goal weight/reps/seconds, bodyweight and time-based flags, and default block assignment.     | [128w](models/exercise.128w.md)         |
