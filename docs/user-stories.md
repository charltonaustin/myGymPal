...
- Each phase has its own rep range (e.g. 14-12 Phase 2, 10–12 in Phase 3, 8–10 in Phase 4); sessions use the rep range
  of their phase
- The last week of every phase is a deload week (same exercises and weight, reps reduced by 2 below the phase
  minimum) -- the number of weeks for phase can be user defined
...
- Weighted exercises auto-adjust goal weight; bodyweight exercises auto-adjust goal reps — both use the same trigger
  rules
- Progression increases after 3 consecutive non-deload sessions hitting the max; decreases after failing the minimum
  once in any non-deload session
