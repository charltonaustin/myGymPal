...
| sessions   | Workout session start form and live logging view with AJAX set submission, rest timer, drag-to-reorder exercises, and goal modals | [32w](views/sessions.32w.md)  |
