...
| exercise   | Full CRUD for the user's exercise library at /exercises; three AJAX POST endpoints for live goal-weight, goal-reps, and goal-seconds updates from within a session.            | [128w](controllers/exercise.128w.md) · [256w](controllers/exercise.256w.md)   |
